...
const divisions = [
  {
    ...
    description:
      "We supply high-grade coal for industrial, commercial, and residential needs. Our extensive network ensures timely delivery and competitive pricing.",
    features: [
  ...
  },
  {
    ...
    description:
      "Authorized dealers of leading cement brands. We provide bulk cement supply for construction projects of all scales with doorstep delivery.",
    features: [
  ...
  },
  {
    ...
    description:
      "Complete range of bricks including fly ash bricks, red bricks, and cement blocks. Perfect for residential and commercial construction projects.",
    features: [
      "Fly ash bricks",
      "Red clay bricks",
      "Cement blocks",
  ...
  },
  {
    ...
    description:
      "Comprehensive real estate services including buying, selling, and rental assistance for residential and commercial properties.",
    features: [
  ...
  },
  {
    ...
    description:
      "Professional forex trading guidance and comprehensive IT solutions including software development, web services, and digital transformation.",
    features: [
