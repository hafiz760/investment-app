      ...
      <div className="container mx-auto">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg">
            Have questions? Want to invest? Our team is ready to assist you with
            all your queries.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div
            className="bg-gradient-to-br from-[#0F1C2E] to-[#1a2942] border border-[#D4AF37]/30 rounded-2xl p-8"
            data-aos="fade-right"
          >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Business Avenue, Main Commercial Area
                      <br />
                      Karachi, Pakistan
                    </p>
                  </div>
