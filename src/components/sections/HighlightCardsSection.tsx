      ...
      <div className="container mx-auto">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg">
            Operating across multiple sectors to provide comprehensive business
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-[#0F1C2E]/80 leading-relaxed mb-6 text-lg">
                  Invest in our diversified portfolio and earn consistent ROI.
                  Multiple investment plans available with flexible tenure and
                  attractive returns.
                </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#0F1C2E]/10 rounded-lg p-6 text-center">
                  <div className="text-4xl font-bold text-[#0F1C2E] mb-2">
                    12-18%
                  </div>
