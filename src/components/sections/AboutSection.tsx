...
export default function AboutSection() {
  return (
    <section id="about" className="section-padding py-10 lg:py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6" data-aos="fade-right">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              InvestaX is a diversified business group operating across multiple
              high-growth sectors including Coal, Cement, Bricks, Real Estate,
              Forex, and IT. We combine traditional business strength with
          ...
          <div className="space-y-6" data-aos="fade-left">
            <div className="bg-gradient-to-br from-[#D4AF37] to-[#C4A037] rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-[#0F1C2E] mb-4">
                Our Mission
              </h3>
              <p className="text-[#0F1C2E]/80 leading-relaxed">
                To provide reliable business solutions and secure investment
                opportunities that create lasting value for our clients,
                investors, and partners across all our business divisions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#0F1C2E] to-[#1a2942] border border-[#D4AF37]/30 rounded-2xl p-8">
              ...
              <p className="text-white/70 leading-relaxed">
                To become Pakistan&apos;s most trusted diversified business
                group, known for excellence in operations, transparency in
                dealings, and consistent returns for our stakeholders.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-white/70">
                    Multi-sector presence ensures portfolio diversification
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#D4AF37] flex-shrink-0 mt-1" />
                  <span className="text-white/70">
                    Transparent ROI structure with regular payouts
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#D4AF37] flex-shrink-0 mt-1" />
