...
const testimonials = [
  {
    ...
    content:
      "InvestaX has been a game-changer for my investment portfolio. The monthly ROI is consistent, and their transparency in operations gives me complete peace of mind. Highly recommended for serious investors.",
    rating: 5,
  },
  {
    name: "Fatima Malik",
    ...
    content:
      "I was initially skeptical about ROI-based investments, but InvestaX proved me wrong. Their professional team, clear documentation, and regular updates make them stand out from others.",
    rating: 5,
  },
  {
    name: "Imran Siddiqui",
    ...
    content:
      "The diversified business model of InvestaX across coal, cement, and real estate provides excellent security. I've been investing for 18 months and the returns have exceeded my expectations.",
    rating: 5,
  },
];
...
export default function TestimonialsSection() {
  return (
    <section id="testimonials" className="section-padding py-10 lg:py-20">
      <div className="container mx-auto">
        ...
        <div
          id="certifications"
          className="bg-gradient-to-br from-[#D4AF37] to-[#C4A037] rounded-3xl p-12"
          data-aos="fade-up"
        >
          <div className="text-center mb-12">
            ...
            <p className="text-[#0F1C2E]/80 max-w-2xl mx-auto text-lg">
              Your investment security is our priority. We operate with complete
          ...
          <div className="mt-12 text-center">
            <p className="text-[#0F1C2E]/80 mb-6">
              All legal documents, certificates, and registration details are
